...
Revises: 
Create Date: 2025-08-09 12:50:00.000000
...
def upgrade():
    ...
    op.create_table('eligibility_assessments',
        ...
        sa.Column('eligibility_score', sa.Numeric(precision=10, scale=2), nullable=True),
    ...
    op.create_index('ix_eligibility_assessments_household_id', 'eligibility_assessments', ['household_id'])
    op.create_index('ix_eligibility_assessments_status', 'eligibility_assessments', ['eligibility_status'])
    op.create_index('ix_eligibility_assessments_assessment_date', 'eligibility_assessments', ['assessment_date'])
    op.create_index('ix_eligibility_assessments_assessed_by', 'eligibility_assessments', ['assessed_by'])
    ...
    op.create_table('processed_events',
        ...
        sa.Column('consumer_group', sa.String(length=100), nullable=False, default='eligibility'),
    )
